...
<main class="form-signin w-100 m-auto">
  <form method="post">
  <a href="home">
    <img class="mb-4 rounded-circle shadow" src="<?=ROOT?>/assets/images/logo.png" alt="" width="90" height="65" style="object-fit: cover;">
  </a>
    ...
    <div class="form-floating">
      <input type="retype_password" class="form-control mb-2" id="floatingPassword" placeholder="retype assword">
      <label for="floatingPassword"> retype password</label>
    </div>

    <div class="my-2">already have an account? <a href="<?=ROOT?>/login">Sign in here</a></div>
